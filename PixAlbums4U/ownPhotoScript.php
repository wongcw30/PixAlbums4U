...
$("#copyBtn").click(function() { //when you click the COPY button, then a pop out window.
  window.prompt("Copy to clipboard: Ctrl+C, Enter", $("#shareLink").val());
});//generate the link for copy 
	...
	success: function( json ) {
		...
		if(!invalidAlbum) {
			...
			if(userInfo.album[<?php echo $_GET['albumNo'];?>].photo.length > 0) {
				...
				pic_empty1.style.display = "35px Segoe UI, Sans-serif";
